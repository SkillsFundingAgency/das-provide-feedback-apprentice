namespace ESFA.DAS.ProvideFeedback.Apprentice.Data
{
    ...
    public abstract class CosmosDbRepositoryBase<TInstance> : IDataRepository
        where TInstance : class, IDataRepository
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TInstance"/> class.
        /// </summary>
        ...
        public TInstance WithAuthKeyOrResourceToken(string keyOrToken)
        {
        ...
        /// </returns>
        public TInstance UsingCollection(string collectionName)
        {
        ...
        /// </param>
        /// <returns>A CosmosDB <see cref="CosmosDbRepository" /></returns>
        public TInstance WithConnectionString(string connectionString)
        {
        ...
        /// <returns>A CosmosDB <see cref="CosmosDbRepository" /></returns>
        public TInstance UsingDatabase(string databaseName)
        {
        ...
        /// <returns>A CosmosDB <see cref="CosmosDbRepository" /></returns>
        public TInstance ConnectTo(string endpoint)
        {
        ...
        /// <returns>A CosmosDB <see cref="CosmosDbRepository" /></returns>
        public TInstance WithPartitionKey(string pk)
        {
