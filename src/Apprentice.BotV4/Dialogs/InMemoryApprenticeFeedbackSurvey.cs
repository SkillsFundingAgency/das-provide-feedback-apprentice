namespace ESFA.DAS.ProvideFeedback.Apprentice.BotV4.Dialogs
{
    ...
    public class InMemoryApprenticeFeedbackSurvey : ISurvey
    {
        ...
        private const string QuestionsTrainerKnowledge = 
            "Next question, is your trainer good?";

        private const string ResponsesItsReallyHelpful = 
        ...
        private const string ResponsesSorryToHearThat = 
